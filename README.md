...
Run the following commands in your preferred shell:
    ...
    curl -s https://raw.githubusercontent.com/pvdb/repl/master/repl -o "${REPL_INSTALL_DIR}/repl"
...
After checking out the repo, you can make changes to the  `repl` Ruby script itself to change its behaviour, and/or to the `repl.1.ronn` Markdown file to update the documentation.
